...
\begin{equation*}
\frac{3.3V}{2^{12}} = 0.0008056640625V \approx 0.8mV
\end{equation*}
...
\begin{equation*}
\frac{5V}{2^{10}} = 0.0048828125V \approx 5mV
\end{equation*}
